...
namespace RestroFlowAPI.Migrations.RestroFlowDb
{
    ...
    [Migration("20240911133956_change table names")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RestroFlowAPI.Models.IncomeSources", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 9, 11, 23, 39, 55, 294, DateTimeKind.Local).AddTicks(1087),
                            IncomeType = "Dine-in",
                            UpdatedAt = new DateTime(2024, 9, 11, 23, 39, 55, 294, DateTimeKind.Local).AddTicks(1258)
                        },
                        new
                        {
                            Id = new Guid("6eff914c-554b-47f2-b77f-a1b652f63337"),
                            CreatedAt = new DateTime(2024, 9, 11, 23, 39, 55, 294, DateTimeKind.Local).AddTicks(1457),
                            IncomeType = "Delivery",
                            UpdatedAt = new DateTime(2024, 9, 11, 23, 39, 55, 294, DateTimeKind.Local).AddTicks(1461)
                        },
                        new
                        {
                            Id = new Guid("4fd74864-68d0-44c7-ae4d-548aef790aad"),
                            CreatedAt = new DateTime(2024, 9, 11, 23, 39, 55, 294, DateTimeKind.Local).AddTicks(1464),
                            IncomeType = "Take-away",
                            UpdatedAt = new DateTime(2024, 9, 11, 23, 39, 55, 294, DateTimeKind.Local).AddTicks(1465)
                        });
                });
            ...
            modelBuilder.Entity("RestroFlowAPI.Models.RestaurantItems", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 9, 11, 23, 39, 55, 293, DateTimeKind.Local).AddTicks(9996),
                            Name = "Whole chicken",
                            RestaurantId = new Guid("cc0db03e-f425-459f-88ca-26496d389dc1"),
                            SupplierId = new Guid("0a04327d-3b36-40ea-8759-f3d479e36529"),
                            Unit = "Portion",
                            UpdatedAt = new DateTime(2024, 9, 11, 23, 39, 55, 294, DateTimeKind.Local).AddTicks(133)
                        },
                        new
                        {
                            Id = new Guid("122f8ddc-47dd-45e9-8bb5-6b1a3bd1949a"),
                            CreatedAt = new DateTime(2024, 9, 11, 23, 39, 55, 294, DateTimeKind.Local).AddTicks(508),
                            Name = "Boneless chicken",
                            RestaurantId = new Guid("cc0db03e-f425-459f-88ca-26496d389dc1"),
                            SupplierId = new Guid("0a04327d-3b36-40ea-8759-f3d479e36529"),
                            Unit = "box",
                            UpdatedAt = new DateTime(2024, 9, 11, 23, 39, 55, 294, DateTimeKind.Local).AddTicks(513)
                        },
                        new
                        {
                            Id = new Guid("116d32b5-4407-4fe4-9c6e-2aa38c8b6712"),
                            CreatedAt = new DateTime(2024, 9, 11, 23, 39, 55, 294, DateTimeKind.Local).AddTicks(518),
                            Name = "Chicken wings",
                            RestaurantId = new Guid("cc0db03e-f425-459f-88ca-26496d389dc1"),
                            SupplierId = new Guid("0a04327d-3b36-40ea-8759-f3d479e36529"),
                            Unit = "container",
                            UpdatedAt = new DateTime(2024, 9, 11, 23, 39, 55, 294, DateTimeKind.Local).AddTicks(519)
                        },
                        new
                        {
                            Id = new Guid("f8472b62-e223-4033-8fb4-59a762cd0f12"),
                            CreatedAt = new DateTime(2024, 9, 11, 23, 39, 55, 294, DateTimeKind.Local).AddTicks(524),
                            Name = "Chicken Steak",
                            RestaurantId = new Guid("cc0db03e-f425-459f-88ca-26496d389dc1"),
                            SupplierId = new Guid("0a04327d-3b36-40ea-8759-f3d479e36529"),
                            Unit = "container",
                            UpdatedAt = new DateTime(2024, 9, 11, 23, 39, 55, 294, DateTimeKind.Local).AddTicks(525)
                        },
                        new
                        {
                            Id = new Guid("973d9cfe-b929-4cf3-ab02-8dfeb1fa9442"),
                            CreatedAt = new DateTime(2024, 9, 11, 23, 39, 55, 294, DateTimeKind.Local).AddTicks(579),
                            Name = "Marinated beef",
                            RestaurantId = new Guid("cc0db03e-f425-459f-88ca-26496d389dc1"),
                            SupplierId = new Guid("0a04327d-3b36-40ea-8759-f3d479e36529"),
                            Unit = "portion",
                            UpdatedAt = new DateTime(2024, 9, 11, 23, 39, 55, 294, DateTimeKind.Local).AddTicks(581)
                        },
                        new
                        {
                            Id = new Guid("ea6d6784-afbe-4045-809d-90c3a972f12d"),
                            CreatedAt = new DateTime(2024, 9, 11, 23, 39, 55, 294, DateTimeKind.Local).AddTicks(586),
                            Name = "Chicken powder",
                            RestaurantId = new Guid("cc0db03e-f425-459f-88ca-26496d389dc1"),
                            SupplierId = new Guid("cf762d80-3731-4d9d-af92-b77f99676005"),
                            Unit = "bag",
                            UpdatedAt = new DateTime(2024, 9, 11, 23, 39, 55, 294, DateTimeKind.Local).AddTicks(588)
                        },
                        new
                        {
                            Id = new Guid("f87c819a-5b3a-4c09-bb42-b387790b70c0"),
                            CreatedAt = new DateTime(2024, 9, 11, 23, 39, 55, 294, DateTimeKind.Local).AddTicks(592),
                            Name = "Soy garlic",
                            RestaurantId = new Guid("cc0db03e-f425-459f-88ca-26496d389dc1"),
                            SupplierId = new Guid("cf762d80-3731-4d9d-af92-b77f99676005"),
                            Unit = "bag",
                            UpdatedAt = new DateTime(2024, 9, 11, 23, 39, 55, 294, DateTimeKind.Local).AddTicks(594)
                        },
                        new
                        {
                            Id = new Guid("51a801ff-89b7-4663-a308-b0b577018e14"),
                            CreatedAt = new DateTime(2024, 9, 11, 23, 39, 55, 294, DateTimeKind.Local).AddTicks(599),
                            Name = "Spicy sauce",
                            RestaurantId = new Guid("cc0db03e-f425-459f-88ca-26496d389dc1"),
                            SupplierId = new Guid("cf762d80-3731-4d9d-af92-b77f99676005"),
                            Unit = "bag",
                            UpdatedAt = new DateTime(2024, 9, 11, 23, 39, 55, 294, DateTimeKind.Local).AddTicks(600)
                        },
                        new
                        {
                            Id = new Guid("7a456054-4b0c-4005-8623-b4a7ecfb4103"),
                            CreatedAt = new DateTime(2024, 9, 11, 23, 39, 55, 294, DateTimeKind.Local).AddTicks(607),
                            Name = "Sweet Chiilies",
                            RestaurantId = new Guid("cc0db03e-f425-459f-88ca-26496d389dc1"),
                            SupplierId = new Guid("cf762d80-3731-4d9d-af92-b77f99676005"),
                            Unit = "bag",
                            UpdatedAt = new DateTime(2024, 9, 11, 23, 39, 55, 294, DateTimeKind.Local).AddTicks(609)
                        },
                        new
                        {
                            Id = new Guid("a50a5bdf-e0bb-41ae-b23d-87d5076265a7"),
                            CreatedAt = new DateTime(2024, 9, 11, 23, 39, 55, 294, DateTimeKind.Local).AddTicks(614),
                            Name = "Wedges",
                            RestaurantId = new Guid("cc0db03e-f425-459f-88ca-26496d389dc1"),
                            SupplierId = new Guid("cf762d80-3731-4d9d-af92-b77f99676005"),
                            Unit = "bag",
                            UpdatedAt = new DateTime(2024, 9, 11, 23, 39, 55, 294, DateTimeKind.Local).AddTicks(615)
                        });
                });
            ...
            modelBuilder.Entity("RestroFlowAPI.Models.Suppliers", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 9, 11, 23, 39, 55, 293, DateTimeKind.Local).AddTicks(7017),
                            Name = "Complete Food Services",
                            State = "VIC",
                            UpdatedAt = new DateTime(2024, 9, 11, 23, 39, 55, 293, DateTimeKind.Local).AddTicks(7593)
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 9, 11, 23, 39, 55, 293, DateTimeKind.Local).AddTicks(7604),
                            Name = "Fresh Food Industries",
                            State = "VIC",
                            UpdatedAt = new DateTime(2024, 9, 11, 23, 39, 55, 293, DateTimeKind.Local).AddTicks(7606)
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 9, 11, 23, 39, 55, 293, DateTimeKind.Local).AddTicks(7619),
                            Name = "GFI Foods",
                            State = "VIC",
                            UpdatedAt = new DateTime(2024, 9, 11, 23, 39, 55, 293, DateTimeKind.Local).AddTicks(7620)
                        });
                });
            ...
            modelBuilder.Entity("RestroFlowAPI.Models.Sales", b =>
                {
                    b.HasOne("RestroFlowAPI.Models.IncomeSources", "IncomeSources")
                        .WithMany()
